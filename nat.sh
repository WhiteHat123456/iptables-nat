...
# i'm from https://github.com/arloor/iptablesUtils
...
echo
setupService(){
    wget -qO /usr/local/bin/dnat.sh https://raw.githubusercontent.com/WhiteHat123456/iptables-nat/master/dnat.sh||{
